...
@Component
public class CustomHandlerAdvise implements ConfigurationPropertiesBindHandlerAdvisor {
    ...
    private ConfigurationPropertyName findDefaultName(final ConfigurationPropertyName name) {
        final ConfigurationPropertyName from = ConfigurationPropertyName.of("my-properties.properties");
        final ConfigurationPropertyName to = ConfigurationPropertyName.of("my-properties.default");
